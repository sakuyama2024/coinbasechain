...
CMainParams::CMainParams()
{
    ...
    // Genesis block:
    // Mined on: 2025-10-12
    // Block hash: 36de9b76dcd7899a52bab783f185c2563884afb4c6ee9f3b20a51e13a284cfa7
    genesis = CreateGenesisBlock(
        1760292878,   // nTime - Oct 12, 2025
    ...
    assert(consensus.hashGenesisBlock == uint256S("0x36de9b76dcd7899a52bab783f185c2563884afb4c6ee9f3b20a51e13a284cfa7"));
...
CTestNetParams::CTestNetParams()
{
    ...
    // Block hash: cb608755c4b2bee0b929fe5760dec6cc578b48976ee164bb06eb9597c17575f8
    genesis = CreateGenesisBlock(
        1760549555,   // Oct 15, 2025
    ...
    consensus.hashGenesisBlock = genesis.GetHash();
    assert(consensus.hashGenesisBlock == uint256S("0xcb608755c4b2bee0b929fe5760dec6cc578b48976ee164bb06eb9597c17575f8"));
...
CRegTestParams::CRegTestParams()
{
    ...
    consensus.nRandomXEpochDuration = 365 * 24 * 60 * 60;  // 1 year (so all regtest blocks stay in same epoch)
    ...
    genesis = CreateGenesisBlock(
        1296688602,   // Just use a fixed time
        2,            // Easy nonce
