...
const CBlockIndex* LastCommonAncestor(const CBlockIndex* pa, const CBlockIndex* pb)
{
    ...
    // Return common ancestor (could be nullptr if chains diverged from different genesis)
    // Caller MUST check for nullptr and handle gracefully
