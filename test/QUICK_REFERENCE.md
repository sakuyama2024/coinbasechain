...
- Full docs: `test2/README.md`
- Framework guide: `test/network/IMPROVED_TESTING.md`
- Examples: `test2/network/dos_attack_tests.cpp`
- Examples: `test2/network/permission_tests.cpp`
