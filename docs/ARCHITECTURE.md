...
**Key Difference from Bitcoin**: We replace the merkleRoot field with minerAddress since there are no transactions, and add a 32-byte RandomX hash field.
