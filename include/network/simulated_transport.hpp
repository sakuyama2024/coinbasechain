 ...
 *
 * Routes messages through SimulatedTransport's message queue instead of real sockets.
 */
class SimulatedTransportConnection : public TransportConnection,
...
public:
    ...
    std::weak_ptr<SimulatedTransportConnection> get_peer_connection() const { return peer_connection_; }
