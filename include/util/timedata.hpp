...
// This matches Bitcoin Core's DEFAULT_MAX_TIME_ADJUSTMENT
 ...
 * We calculate the offset: peer_time - our_time, and feed it into a median filter.
 * Once we have at least 5 samples, we use the median offset (capped to ±70 minutes).
 *
