#!/bin/bash
# Quick deployment script for CoinbaseChain regtest network
...
echo -e "${GREEN}========================================${NC}"
echo -e "${GREEN}CoinbaseChain Ansible Deployment${NC}"
echo -e "${GREEN}========================================${NC}"
echo ""
...
if ! ansible coinbasechain_nodes -i $INVENTORY -m ping &> /dev/null; then
...
ansible-playbook -i $INVENTORY deploy-coinbasechain.yml
