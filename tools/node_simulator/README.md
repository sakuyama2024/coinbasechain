...
A C++ utility for testing P2P protocol behavior and DoS protection mechanisms in the CoinbaseChain network.
...
./build/bin/node_simulator --host 192.168.1.100 --port 18444 --test all
```
